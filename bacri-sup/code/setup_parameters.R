...
source("bacri-sup/code/packages.R")
source("bacri-sup/functions/utils.R")
...
load("bacri-sup/data/fetal-lamb.RData")
lamb_data <- lamb
rm(lamb)

# Loading the tinnitus dataset
load("bacri-sup/data/tinnitus.RData")
...
# TMB SETUP
# TMB::precompile()
TMB::compile("bacri-sup/code/poi_hmm.cpp")
dyn.load(dynlib("bacri-sup/code/poi_hmm"))
TMB::compile("bacri-sup/code/norm_hmm.cpp")
dyn.load(dynlib("bacri-sup/code/norm_hmm"))
TMB::compile("bacri-sup/code/mvnorm_hmm.cpp")
dyn.load(dynlib("bacri-sup/code/mvnorm_hmm"))
